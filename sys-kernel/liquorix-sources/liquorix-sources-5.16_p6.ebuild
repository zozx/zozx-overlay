...
${GENPATCHES_URI}
https://github.com/zozx/customkernel/releases/download/v5.16-patch/v5.16.8-lqx2.patch
https://github.com/zozx/customkernel/releases/download/v5.16-patch/v1-cjktty-5.16.patch
"
KEYWORDS="~amd64"
